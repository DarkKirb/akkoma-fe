{
  ...
  packages = [
    ...
    {
      name = "chromedriver___chromedriver_120.0.2.tgz";
      path = fetchurl {
        name = "chromedriver___chromedriver_120.0.2.tgz";
        url = "https://registry.yarnpkg.com/chromedriver/-/chromedriver-120.0.2.tgz";
        sha512 = "A6/feXNWoKzkoUISJs/JAi0iIa+t6vwUnQCgGGFK7L/1r7CrreaRynVgnIliQJRdwY/8F41r6Mt3WDD9QXdV8A==";
      };
    }
    {
    ...
    {
      name = "vue_eslint_parser___vue_eslint_parser_9.4.1.tgz";
      path = fetchurl {
        name = "vue_eslint_parser___vue_eslint_parser_9.4.1.tgz";
        url = "https://registry.yarnpkg.com/vue-eslint-parser/-/vue-eslint-parser-9.4.1.tgz";
        sha512 = "EmIbJ5cCI/E06SlI8K5sldVZ+Ef5vy26Ck0lNALxgY7FEAMOjNR32qcsVM3FUJUbvVWTBEiOy5lQvbhPK/ynBw==";
      };
    }
    {
