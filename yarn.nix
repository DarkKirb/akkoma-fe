{
  ...
  packages = [
    ...
    {
      name = "nightwatch___nightwatch_3.3.3.tgz";
      path = fetchurl {
        name = "nightwatch___nightwatch_3.3.3.tgz";
        url = "https://registry.yarnpkg.com/nightwatch/-/nightwatch-3.3.3.tgz";
        sha512 = "M95DJ4KKe4+wyeJZYrkoiDcDMj45DAfFBr5h+Mkn/tBAO+4dxZyImtnoLG1b2xab14DF3pYICYcIXahyvfwkcg==";
      };
    }
    {
