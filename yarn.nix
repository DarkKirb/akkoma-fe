{
  ...
  packages = [
    ...
    {
      name = "nightwatch___nightwatch_3.5.0.tgz";
      path = fetchurl {
        name = "nightwatch___nightwatch_3.5.0.tgz";
        url = "https://registry.yarnpkg.com/nightwatch/-/nightwatch-3.5.0.tgz";
        sha512 = "gUIlA8T10lKbdPJY7cOAY4hEdyFG3RdhAuklN52J44DrlTS9PbwlH33GnePrrW0H/77+Mxo4cpXGYXi+scONDA==";
      };
    }
    {
